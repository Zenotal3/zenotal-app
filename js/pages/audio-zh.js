document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function generateHybridAudioSession(sessionType) {
        ...
        if (totalSessionDuration > 0) {
            ...
            audioSessionReady = true; // Allow button clicks even in fallback mode
        }
    }
    ...
    function showSessionComplete() {
        ...
        if (userId) {
            ...
            setTimeout(() => { window.location.href = 'sharing-zh.html'; }, 3000);
        }
    }
    ...
    async function generateAndSaveSession(userId) {
        ...
        setTimeout(function() { window.location.href = 'sharing-zh.html'; }, 3000);
    }
    ...
    function finishSession() {
        ...
        window.location.href = 'sharing-zh.html';
    }
    ...
    // BGM disabled - all functions are stubs
    let bgmContext = null;
    let bgmNodes = [];
    ...
    function createBGM() { /* BGM disabled */ }

    function startBGM() { /* BGM disabled */ }

    function pauseBGM() { /* BGM disabled */ }

    function resumeBGM() { /* BGM disabled */ }

    function stopBGM() { /* BGM disabled */ }

    function fadeBGM(targetVolume, durationMs, onComplete) { /* BGM disabled */ if (onComplete) onComplete(); }
    // ─────────────────────────────────────────────────────────────────────────
