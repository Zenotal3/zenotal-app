...
window.initializeEmotionWheel = function() {
    ...
    const emotions = [
        { 
            ...
            strokeColor: '#782F1E',
            text: '愉悦',
            subEmotions: ['开心', '满足', '感兴趣', '自豪', '好奇', '乐观']
        },
        { 
            name: 'angry', 
            color: '#BBBBDB',
        ...
        { 
            ...
            strokeColor: '#613B10',
            text: '惊讶',
            subEmotions: ['惊奇', '困惑', '吓一跳', '茫然', '震惊', '不确定']
        },
        { 
            name: 'fearful', 
            color: '#81D6E1',
        ...
        { 
            ...
            strokeColor: '#481B4D',
            text: '厌恶',
            subEmotions: ['排斥', '不赞同', '恶心', '骇然', '反感', '评判']
        },
        { 
            name: 'sad', 
            color: '#F0BEC5',
        ...
        { 
            ...
            strokeColor: '#073B33',
            text: '不安',
            subEmotions: ['压力大', '局促', '无聊', '疲惫', '不堪重负', '冷漠']
        }
    ];
    ...
    function showConversationPage() {
        ...
        window.location.href = 'conversation-zh.html';
    }
